...
namespace Deep {
	...
	void Capsule::drawDebug(DebugRenderer& debugRenderer, Deep::ColorRGBA8 &lineColor) {
		Deep::ColorRGBA8 color = lineColor;
		// Draw box
		glm::vec4 destRect;
		...
		destRect.w = m_dimensions.y + m_dimensions.x / 3.0f;
