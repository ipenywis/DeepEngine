...
Deep::DebugRenderer::DebugRenderer() {
    // Empty
}
...
void Deep::DebugRenderer::drawLine(const glm::vec2& a, const glm::vec2& b, const ColorRGBA8& color) {
    int i = m_verts.size();
...
void Deep::DebugRenderer::drawBox(const glm::vec4& destRect, const ColorRGBA8& color, float angle) {
...
void Deep::DebugRenderer::drawCircle(const glm::vec2& center, const ColorRGBA8& color, float radius) {
...
void Deep::DebugRenderer::render(const glm::mat4& projectionMatrix, float lineWidth) {
    m_program.use();
...
void Deep::DebugRenderer::dispose() {
    if (m_vao) {
