...
/*
void SpriteBatch::draw(std::string id, int margin, int spacing, int x, int y,
	int width, int height, int currentRow, int currentFrame, SDL_Renderer *pRenderer, ) {

	SDL_Rect srcRect; // UVRect
	SDL_Rect destRect;// DestRect
...
void SpriteBatch::renderBatch() {
    ...
    for (size_t i = 0; i < _renderBatches.size(); i++) {
		...
		//glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_MAX_ANISOTROPY_EXT, 0); ///< Added Code for Gaps Fixing 
